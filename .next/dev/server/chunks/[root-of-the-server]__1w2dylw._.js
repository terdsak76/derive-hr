...
"[project]/src/app/api/employee-summary/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function daysInRange(start, end, monthStart, monthEnd) {
...
async function GET(request) {
    ...
    const activityWhere = session.role.toUpperCase() === 'ADMIN' ? undefined : {
    ...
    try {
        const [employees, attendances, leaves, workdayChanges, onsites] = await Promise.all([
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].attendance.findMany({
                where: {
                    ...activityWhere,
                    date: {
                        gte: monthStart,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].leave.findMany({
                where: {
                    ...activityWhere,
                    startDate: {
                        lte: monthEnd
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].workdayChangeRequest.findMany({
                where: {
                    ...activityWhere,
                    fromDate: {
                        gte: monthStart,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].onsite.findMany({
                where: {
                    ...activityWhere,
                    startDate: {
                        lte: monthEnd
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Unable to load employee summary'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1w2dylw._.js.map