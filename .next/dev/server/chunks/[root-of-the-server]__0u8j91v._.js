...
"[project]/src/app/api/workday-changes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getSession(request) {
    const token = request.headers.get('cookie')?.split(';').map((value)=>value.trim()).find((value)=>value.startsWith(`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionCookieName"])()}=`))?.split('=')[1];
    return token ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifySessionToken"])(token) : null;
}
...
async function GET(request) {
    ...
    const requests = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].workdayChangeRequest.findMany({
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(requests.map(serializeRequest));
}
async function POST(request) {
    ...
    try {
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].workdayChangeRequest.create({
            data: {
                employeeId: session.employeeId,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(serializeRequest(created), {
            status: 201
        });
    } catch (error) {
...
async function PATCH(request) {
    ...
    if (!session || session.role !== 'ADMIN') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'เฉพาะ Admin เท่านั้นที่อนุมัติคำขอได้'
        }, {
            status: 403
        });
    }
    ...
    const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].workdayChangeRequest.update({
        where: {
            id: body.id
        },
        data: {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(serializeRequest(updated));
}
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__0u8j91v._.js.map