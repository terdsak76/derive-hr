...
async function GET(request) {
    ...
    const requests = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].workdayChangeRequest.findMany({
...
async function POST(request) {
    ...
    try {
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].workdayChangeRequest.create({
            data: {
                employeeId: session.employeeId,
...
async function PATCH(request) {
    ...
    const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].workdayChangeRequest.update({
        where: {
            id: body.id
        },
        data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1syp47s._.js.map